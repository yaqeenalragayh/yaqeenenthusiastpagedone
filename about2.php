    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="gallery2.php" class="nav-item nav-link">Gallary</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="home2.html #courses" class="dropdown-item">courses</a>
                        <a href="home2.html #events" class="dropdown-item">events and Exhibitions</a>
                        <a href="home2.html #challenges" class="dropdown-item">Competitions</a>
                    </div>
                </div>
